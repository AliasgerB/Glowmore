...
function ShowAllBookings() {
  ...
  const handleApply = async () => {
    try {
      ...
      showNotification(
        error.response?.data || "Error applying date filter.",
        "error"
      );
    }
  };
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 p-2 rounded border border-gray-300 focus:outline-none focus:ring-1 focus:ring-accent w-full"
            />
          </div>
