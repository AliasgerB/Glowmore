...
function NewBooking() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      let submitResponce = await axios.post(
      ...
      showNotification(submitResponce.data, "success");
    } catch (error) {
      showNotification(
        error.response?.data || "Error adding booking.",
        "error"
      );
    }
  };
    ...
    >
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full p-2 rounded bg-white border border-gray-300 text-textDark focus:outline-none focus:ring-1 focus:ring-accent"
          required
        />
      </div>
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full p-2 rounded bg-white border border-gray-300 text-textDark focus:outline-none focus:ring-1 focus:ring-accentfocus:outline-none focus:ring-1 focus:ring-accent"
        />
      </div>
      ...
      <button
        type="submit"
        className="bg-accent text-primary py-2 px-4 rounded hover:bg-accent hover:text-primary font-bold transform hover:scale-110 transition-transform"
      >
        Submit
      </button>
    </form>
