  ...
  return (
    ...
    >
      <div className="p-6 rounded-lg">
        <h1 className="text-4xl text-textLight font-bold mb-4">
          Welcome to Glowmoree By Hawwa Makeup
        </h1>
        <p className="text-lg text-textLight mb-6 font-bold">
          Your luxury makeup destination.
        </p>
        <button className="px-6 py-2 bg-accent text-primary font-semibold rounded hover:bg-textPrimary hover:text-textLight">
